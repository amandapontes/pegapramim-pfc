	...
	<link rel="stylesheet" href="<?php echo base_url()?>resources/bootstrap/css/doc.css" />

	<!-- Optional theme -->
	<link rel="stylesheet" href="<?php echo base_url()?>resources/bootstrap/css/bootstrap-theme.min.css" />
